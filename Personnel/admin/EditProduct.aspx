<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="EditProduct.aspx.cs" Inherits="Personnel_admin_EditProduct" %>
            ...
            <div class="col-md-12 ">
               <div class="panel panel-info">
                       ...
                       <div class="col-md-6  col-sm-6"> 
                                ...
                                <asp:Label ID="lblddlProType" runat="server" Text="Product Type" ></asp:Label>
                                             <asp:DropDownList AppendDataBoundItems="true" ID="cmbProType" CssClass="form-control"
                                              AutoPostBack="true"   runat="server" DataSourceID="SqlDataSource2" OnSelectedIndexChanged="cmbProType_SelectedIndexChanged"
                                                  DataTextField="varProductType" DataValueField="varProductType">
                                             ...
                                             <asp:SqlDataSource runat="server" ID="SqlDataSource2" 
                                                 ConnectionString='<%$ ConnectionStrings:sanghaviunbreakablesConnectionString13 %>' 
                                                 ProviderName='<%$ ConnectionStrings:sanghaviunbreakablesConnectionString13.ProviderName %>'
                                                 ></asp:SqlDataSource>
                                             </div>
                                             <div class="form-group">
                                <asp:Label ID="lblddlProSubType" runat="server" Text="Product SubType" ></asp:Label>
                                                 <asp:DropDownList AppendDataBoundItems="true" ID="cmbProSubType" DataTextField="varProductSubType" DataValueField="varProductSubType" runat="server" CssClass="form-control" DataSourceID="SqlDataSourceSubtype">
                                                     <asp:ListItem>--Select SubType--</asp:ListItem>
                                                 </asp:DropDownList>
                                                 <asp:SqlDataSource runat="server" ID="SqlDataSourceSubtype" 
                                ...
                                <asp:TextBox ID="txtProductName" runat="server" class="form-control"  pattern=".*[^ ].*" ></asp:TextBox>
                                        </div> 
                                         <div class="form-group">
                                ...
                                <div class="form-group">
                                             ...
                                             <asp:TextBox ID="txtSize" runat="server" class="form-control"  ></asp:TextBox>
                                              <br />
                                             <asp:DropDownList ID="cmbUnit" runat="server" class="form-control"  >
                                             <asp:ListItem>--Select Unit--</asp:ListItem>
                                               ...
                                               <div class="form-group">
                                             <asp:Label ID="lblPack" runat="server" Text="Packing"  ></asp:Label>
                                             <asp:TextBox ID="txtPack" runat="server"  class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ></asp:TextBox>
                                        </div>   
                               ...
                               <div class="form-group">
                                                     <asp:Label ID="Label6" runat="server" Text="Product Weight."  ></asp:Label>
                            ...
                            <div class="form-group">
                            Warning Nag
                              <asp:TextBox ID="txtWarningNag" runat="server" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ></asp:TextBox>
                            </div>
                              <div class="form-group">
                               Warning Sack
                              <asp:TextBox ID="txtWarningSack" runat="server" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ></asp:TextBox>
                              </div>
                                                            <div class="form-group">
                                      <asp:Label ID="lblDealerPrice" runat="server" Text="Retail Dealer Price"  ></asp:Label>
                                                <asp:TextBox ID="txtDealerPrice" runat="server" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ></asp:TextBox>
                                                 ...
                                                 <div class="form-group">
                                                     <asp:Label ID="lblMRP" runat="server" Text="Retail M.R.P."  ></asp:Label>
                                                     <asp:TextBox ID="txtMRP" runat="server"  class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ></asp:TextBox>
                                                            ...
                                                            <div class="form-group">
                                      <asp:Label ID="Label2" runat="server" Text="MS/MP Dealer Price"  ></asp:Label>
                                                <asp:TextBox ID="txtMSMPDealer" runat="server" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ></asp:TextBox>
                                                </div>
                                                 <div class="form-group">
                                                     <asp:Label ID="Label3" runat="server" Text="MS/MP M.R.P."  ></asp:Label>
                                                     <asp:TextBox ID="txtMSMPPrice" runat="server"  class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"></asp:TextBox>
                                                 </div>   
                                                 
                                                            <div class="form-group">
                                      <asp:Label ID="Label4" runat="server" Text="All State Dealer Price"  ></asp:Label>
                                                <asp:TextBox ID="txtAllStatePrice" runat="server" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ></asp:TextBox>
                                                </div>
                                                 <div class="form-group">
                                                     <asp:Label ID="Label5" runat="server" Text="All State M.R.P."  ></asp:Label>
                                                     <asp:TextBox onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ID="txtAllStateMRP" runat="server"  class="form-control" ></asp:TextBox>
                                                 </div>  
                                                 <div class="form-group">
                                                     <asp:Label ID="Label8" runat="server" Text="Index Number"  ></asp:Label>
                                                     <asp:TextBox required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ID="txtIndex" runat="server"  class="form-control" ></asp:TextBox>
                                                 </div>  
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload"> 
                                ...
                                <script type="text/javascript">
                                 ...
                                 <div class="form-group">
                                                     <asp:Button ID="btnAdd" runat="server" Text="Update " CssClass="btn btn-success"  OnClientClick="return Confirm();"
                                                         onclick="btnAdd_Click"/>&nbsp;
                                     <asp:Button ID="btnCancel" runat="server" Text="Cancel" class="btn btn-warning" 
