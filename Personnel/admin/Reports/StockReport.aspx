<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockReport.aspx.cs" Inherits="Personnel_admin_Reports_StockReport" %>
 ...
 <a href="../Default.aspx" class="btn btn-info" title="Profile"><i class="fa fa-user fa-2x"></i></a>
     ...
     <asp:LinkButton ID="lnkLogoutUp" runat="server"  CssClass="btn btn-danger fa fa-exclamation-circle fa-2x" 
        ...
        <div id="page-wrapper">
         ...
         <asp:Button ID="btnJalgaonExport" runat="server"  CssClass=" btn btn-success" Text="Export In Excel" OnClick="btnJalgaonExport_Click"  />   &nbsp;&nbsp;              <input type="button" class="btn btn-danger" value="Print" onclick="PrintElem('#output')" />   
