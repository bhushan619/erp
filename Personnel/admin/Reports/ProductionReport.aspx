<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductionReport.aspx.cs" Inherits="Personnel_admin_Reports_ProductionReport" %>
          ...
          <div class="panel panel-info">
             ...
             Production Report 
                       ...
                       <div class="col-lg-12 col-sm-12 "> 
                           ...
                           <asp:LinkButton ID="btnExportProduction" runat="server" OnClick="btnExportProduction_Click" CssClass=" btn btn-success" Text="Export In Excel"  CausesValidation="False" />   
                       <div class="panel  text-center ">
                     
                        <div class="panel-body">  
                          <div class="row">  

                                Total Quantity : <asp:Label ID="lblTotalQuantity" runat="server" Text="0" Font-Bold="True"></asp:Label>
                                              Total Kg Material Used : <asp:Label ID="lblTotalKgUsed" runat="server" Text="0" Font-Bold="True"></asp:Label> 
                      Total Weight : <asp:Label ID="lblTotalWeightUsed" runat="server" Text="0" Font-Bold="True"></asp:Label>
