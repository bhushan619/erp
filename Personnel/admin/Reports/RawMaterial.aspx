<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RawMaterial.aspx.cs" Inherits="Personnel_admin_Reports_RawMaterial" %>
              ...
              Report of Raw Material
                        ...
                        <div class="row">   
                            <div role="form"> 
                             ...
                             <div class="form-group"> 
                                  ...
                                  DataSourceID="SqlDataSourceName" DataTextField="varName" AppendDataBoundItems="true"
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-danger" href="RawMaterial.aspx" >Reset</a>
                 ...
                 <div class="row">   
                       ...
                       <div class="panel panel-primary text-center">
                        ...
                        <div class="panel-body"> 
                      Total Kg Material Used : <asp:Label ID="lblTotalKgUsed" runat="server" Text="0" Font-Bold="True"></asp:Label>
                      Total Ton Material Used : <asp:Label ID="lblTotalTonUsed" runat="server" Text="0" Font-Bold="True"></asp:Label>
                              Total Amount : <asp:Label ID="lbltotAmt" runat="server" Text="0" Font-Bold="True"></asp:Label>
  <asp:LinkButton ID="btnInwardExport" runat="server" CssClass=" btn btn-success" Text="Export In Excel" OnClick="btnInwardExport_Click"  />
                     ...
                     <div class=" table-responsive">
                        ...
                        <div class="panel-body">
                          <div class="row"> 
                            Total Used Kg : <asp:Label ID="lblSack" runat="server" Text="0" Font-Bold="True"></asp:Label>
                      Total Used Ton : <asp:Label ID="lblNug" runat="server" Text="0" Font-Bold="True"></asp:Label>  <asp:LinkButton ID="btnUseExport" runat="server" CssClass=" btn btn-success" Text="Export In Excel" OnClick="btnUseExport_Click"  />
                           <div class="table-responsive">  
