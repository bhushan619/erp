<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Production.aspx.cs" Inherits="Personnel_admin_Reports_Production" %>
     ...
     <asp:LinkButton ID="lnkLogoutUp" runat="server"  class="btn btn-danger fa fa-exclamation-circle fa-2x" 
        ...
        <div id="page-wrapper">
          ...
          <div class="panel panel-info">
              ...
              Report of Product Production and Dispatch (Varkehdi Godown)
                        </div>
                       ...
                       <div class="col-lg-6 col-sm-6 "> 
                           <asp:LinkButton ID="btnExportProduction" runat="server" CssClass=" btn btn-success" Text="Export In Excel" OnClick="btnExportProduction_Click" CausesValidation="False" />   
                     ...
                     <div class="table table-responsive">
                         ...
                         <div class="col-lg-6 col-sm-6 ">  
                             <asp:LinkButton ID="btnExportDispatch" runat="server" CssClass=" btn btn-success" Text="Export In Excel" OnClick="btnExportDispatch_Click" CausesValidation="False" />
                        ...
                        <div class="panel-body">
                          <div class="row"> 
                            Total Sack Dispatched : <asp:Label ID="lblSack" runat="server" Text="0" Font-Bold="True"></asp:Label>
                      Total Nug Dispatched : <asp:Label ID="lblNug" runat="server" Text="0" Font-Bold="True"></asp:Label>
                           <div class="table table-responsive">  
