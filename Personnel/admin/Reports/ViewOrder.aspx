        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
               <div class="panel panel-info">
                                ...
                                <div class="form-group "> 
                                  ...
                                  <div class="col-md-3  col-sm-3">
                                    <div class="form-group">
                                           ...
                                           <a class="btn btn-danger" href="ViewOrder.aspx" >Reset</a>
                        ...
                        <asp:LinkButton ID="btnExport" runat="server" CssClass="btn btn-success" Text="Export In Excel" OnClick="btnExport_Click" CausesValidation="False" />
                         <br />
                                    ...
                                    <tr style="">
                                        ...
                                        <td>
                                         ...
                                         <td>
                                             ...
                                             <asp:LinkButton ID="LinkButton1" OnClientClick="return Confirm();" CommandName="Deletes" CommandArgument='<%#Eval("intOrderId")+","+ Eval("intCustId")%>' runat="server" ToolTip="Delete Order" CssClass="fa fa-times btn btn-xs btn-danger"></asp:LinkButton>
                ...
                <asp:DataPager ID="DataPager1" runat="server" PagedControlID="listorder" PageSize="50">
                    <Fields>
