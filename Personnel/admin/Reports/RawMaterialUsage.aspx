<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RawMaterialUsage.aspx.cs" Inherits="Personnel_admin_Reports_RawMaterialUsage" %>
         ...
         <div class="panel panel-info">
              ...
              Report of Raw Material Usage
                      ...
                      <br />
                                  ...
                                  <asp:GridView ID="grdReport" runat="server" CssClass="table table-bordered table-responsive" PageSize="15">
                                  </asp:GridView>
                           <br />
                           <asp:LinkButton ID="btnExport" runat="server" CssClass=" btn btn-success" Text="Export In Excel" OnClick="btnExport_Click" />
