<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Collection.aspx.cs" Inherits="Personnel_admin_Reports_Collection" %>
                        ...
                        <div class="panel-body">  
                          <div class="row">  
                               ...
                               <div class="table table-responsive">
                                  <asp:GridView ID="grdReport" runat="server" OnRowCommand="grdReport_RowCommand"
                                CssClass="table table-striped table-bordered " AllowPaging="True"
                                OnPageIndexChanging="grdReport_PageIndexChanging" AutoGenerateColumns="False"  >
