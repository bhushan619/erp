<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllocateDistrictReport.aspx.cs" Inherits="Personnel_admin_Reports_AllocateDistrictReport" %>
                      ...
                      <div class="panel panel-info">
                        ...
                        <div class="row"> 
                            ...
                            <h5>Search Employee By Name</h5>
                                 ...
                                 placeholder="Employee Name" class="form-control"   ></asp:TextBox>
                            ...
                            <asp:Button ID="btnSearch" CssClass="btn btn-warning" runat="server" Text="Search" OnClick="btnSearch_Click" />
                                     <a class="btn btn-danger" href="AllocateDistrictReport.aspx" >Reset</a>
                                  &nbsp;&nbsp;&nbsp;<asp:Button ID="btnExport" runat="server" CssClass=" btn btn-success" Text="Export In Excel" OnClick="btnExport_Click" /></div>
                        ...
                        SelectCommand="SELECT intId, varEmpName,varDistrict FROM sanghaviunbreakables.tblsuallocatedistrict">
                            </asp:SqlDataSource>--%>
                                </div>
