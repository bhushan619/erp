<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Transport.aspx.cs" Inherits="Personnel_admin_Reports_Transport" %>
        ...
        <div id="page-wrapper">
         ...
         <div class="panel panel-info">
              ...
              Report of sale of products
                        ...
                        <div class="row">   
                               ...
                               <div class="col-lg-3 col-sm-3">
                                <div class="form-group "> 
                                           <asp:TextBox ID="txtCmpName" runat="server" class="form-control" 
                                                placeholder="-- Select Transport --"  ></asp:TextBox>
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-danger" href="Transport.aspx" >Reset</a>
                    ...
                    Sack Sent : <asp:Label ID="lblSackSent" runat="server" Text="0" Font-Bold="True"></asp:Label>
                    Nug Sent : <asp:Label ID="lblNugSent" runat="server" Text="0" Font-Bold="True"></asp:Label>
                    Total Nug Sent : <asp:Label ID="lblTotal" runat="server" Text="0" Font-Bold="True"></asp:Label>
                          <br />  Total Kg Sent : <asp:Label ID="lblKg" runat="server" Text="0" Font-Bold="True"></asp:Label>
                            Total Price Sent : <asp:Label ID="lblPrice" runat="server" Text="0" Font-Bold="True"></asp:Label>
                                    
                     <div class="table table-responsive">
                                  <asp:GridView ID="grdReport" runat="server" 
                                      CssClass="table table-bordered table-responsive" PageSize="150" 
                                      AutoGenerateColumns="False" onpageindexchanging="grdReport_PageIndexChanging" >
                                  </asp:GridView></div>
                                   </div> 
