<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DispatchExpenseSheet.aspx.cs" Inherits="Personnel_admin_Reports_DispatchExpenseSheet" %>
...
<body>
 ...
 <a href="../Default.aspx" class="btn btn-info" title="Profile"><i class="fa fa-user fa-2x"></i></a>
        ...
        <div id="page-wrapper">
          ...
          <div class="panel panel-info">
              ...
              Dispatch Expense Sheet Report 
                        ...
                        <div class="row">   
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-danger" href="DispatchExpenseSheet.aspx" >Reset</a>
                       ...
                       <div class="col-lg-12 col-sm-12"> 
                           <asp:LinkButton ID="btnDispatchExpenseSheet" runat="server" CssClass=" btn btn-success" Text="Export In Excel"  OnClick="btnDispatchExpenseSheet_Click" CausesValidation="False" />   
                      
                     
                     <div style="overflow-y: hidden;">
     <asp:GridView ID="grdReport" runat="server" OnRowCommand="grdRaw_RowCommand"
     ...
     <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:sanghaviConnectionString %>' ProviderName='<%$ ConnectionStrings:sanghaviConnectionString.ProviderName %>' SelectCommand="SELECT  varNo as No, varDate as Date, varInvoiceNo AS 'Invoice No' , varLRNo as LRNo, varTransporter as Transport, varParty as Party, varSack as Sack, varHamali as Hamali, varTotal as Total FROM tblsudispatchexpensesheet"></asp:SqlDataSource>
         ...
         <asp:GridView ID="grdExport" runat="server" AllowPaging="false"  ></asp:GridView>
                        </div>
