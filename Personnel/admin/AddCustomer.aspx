<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="AddCustomer.aspx.cs" Inherits="Personnel_admin_AddCustomer" %>
                    ...
                    <li>
                       <a href="#" class="active-menu-top"><i class="fa fa-users "></i>Customer<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                          <li>
                                <a href="AddCustomer.aspx" class="active-menu"><i class="fa fa-user "></i>Add Customer</a>
                            </li>
                            <li>
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload"> 
                                ...
                                <input ID="fupProPic" type="file" name="file" onchange="previewFile()"  runat="server" accept='image/*' /></span>
                                     <asp:Image ID="ImgCust" CssClass="fileupload-preview thumbnail" style="width: 200px; height: 150px;float:none"  runat="server" ImageUrl="~/Personnel/admin/media/NoProfile.png" />
                               ...
                               <asp:LinkButton ID="btnUpdate"  runat="server" Text="Add" class="btn btn-warning" onclick="btnUpdate_Click"   OnClientClick="return Confirm();"
                                                  />
