<%@ Page  MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="EditCustomerOther.aspx.cs" Inherits="Personnel_admin_EditCustomerOther" %>
...
<head id="Head1" runat="server">
     ...
     <title>Edit Customer Other Details </title>
...
<body>
 ...
 <a href="Default.aspx" class="btn btn-info" title="Profile"><i class="fa fa-user fa-2x"></i></a>
   ...
   CommandArgument='<%# Eval("intId") %>' CssClass="btn btn-xs btn-danger fa fa-times" />
                               ...
                               <SelectParameters>
                               <asp:SessionParameter Name="cust" DbType="Int64" SessionField="custbyadmin" />
                               </SelectParameters>
                                </asp:SqlDataSource>
                            </div>
                           </div>
