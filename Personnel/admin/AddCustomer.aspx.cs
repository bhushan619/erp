...
public partial class Personnel_admin_AddCustomer : System.Web.UI.Page
{
            ...
            if (confirmValue == "Yes")
            {
                if (txtCmpName.Text == "")
                {
                    ScriptManager.RegisterStartupScript(
                                   ...
                                   this.GetType(),
                                   "MessageBox",
                                   "alert('Please enter company name');", true);
                }
                else if (txtMobile.Text == "")
                {
                    ScriptManager.RegisterStartupScript(
                                   ...
                                   this.GetType(),
                                   "MessageBox",
                                   "alert('Please enter mobile');", true);
                }
                else if (cmbcity.Text == "--Select City--")
                {
                    ScriptManager.RegisterStartupScript(
                                   this,
                                   this.GetType(),
                ...
                else
                {
                    if (dbc.check_already_Customer(txtMail.Text) != 1)
                    {
                        ...
                        if (contentLength == 0)
                        {
                            int insert_ok = dbc.insert_CustomerDetail(txtCmpName.Text, txtRepName.Text, txtMobile.Text, "true", txtLandline.Text, txtMail.Text, "true", txtPasswd.Text, txtADD.Text, cmbcity.Text, cmbstate.Text, "true", txtPAN.Text, txtVat.Text, txtTincard.Text, "", "NoProfile.png", txtDOET.Text);
                            if (insert_ok == 1)
                            {
                                ScriptManager.RegisterStartupScript(
                                   this,
                        ...
                        {
                            //  int insert_ok = dbc.insert_tblEmployeeDetails(txtEmpName.Text, txtMobile.Text, "true", txtMail.Text, "true", txtPasswd.Text, txtADD.Text, cmbcity.Text, cmbstate.Text, "employee", cmbSubDesig.Text, "true", txtIdproof.Text, txtIdproofNo.Text, txtPAN.Text, fileName, txtDob.Text, "adminemp");
                            int insert_ok = dbc.insert_CustomerDetail(txtCmpName.Text, txtRepName.Text, txtMobile.Text, "true", txtLandline.Text, txtMail.Text, "true", txtPasswd.Text, txtADD.Text, cmbcity.Text, cmbstate.Text, "true", txtPAN.Text, txtVat.Text, txtTincard.Text, "", fileName, txtDOET.Text);
                            if (insert_ok == 1)
                            {

                                fupProPic.PostedFile.SaveAs(Server.MapPath("~/Personnel/customer/media/") + fileName);//Or code to save in the DataBase.
                                ScriptManager.RegisterStartupScript(
                                   this,
                                   this.GetType(),
                                   "MessageBox",
