<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="EditEmp.aspx.cs" Inherits="Personnel_admin_EditEmp" %>
...
<body>
 ...
 <a href="Default.aspx" class="btn btn-info" title="Profile"><i class="fa fa-user fa-2x"></i></a>
     ...
     <asp:LinkButton ID="lnkLogoutUp" runat="server"  class="btn btn-danger fa fa-exclamation-circle fa-2x" 
                   ToolTip="Logout" onclick="lnkLogoutUp_Click" 
                    oncommand="lnkLogoutUp_Click"    ></asp:LinkButton>      
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload"> 
                                ...
                                <input ID="fupProPic" type="file" name="file" onchange="previewFile()"  runat="server" accept='image/*' /></span>
                                     <asp:Image ID="ImgempPic" CssClass="fileupload-preview thumbnail" style="width: 200px; height: 150px;float:none"  runat="server" ImageUrl="~/Personnel/admin/media/NoProfile.png" />
                               ...
                               <div class="form-group">
                              &nbsp;&nbsp;&nbsp; <asp:Button ID="btnUpdate"  runat="server" Text="Update" class="btn btn-warning" onclick="btnUpdate_Click"  OnClientClick="return Confirm();"
                                                  />
...
<%--<div class="col-md-4  col-sm-4">
     ...
     <div class="form-group">
                                                     <asp:Label ID="Label25" runat="server" Text="Select Product Image to Upload"></asp:Label>
                                <input ID="fupProPic" type="file" name="file" onchange="previewFile()"  runat="server" accept='image/*' class=""/> 
                                  </div>
                                
                                   <div class="form-group">
                                       <asp:Image ID="ImgempPic" CssClass="img-thumbnail"  runat="server" />
                                <script type="text/javascript">
                                    function previewFile() {
