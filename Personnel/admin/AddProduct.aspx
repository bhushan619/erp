<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="AddProduct.aspx.cs" Inherits="Personnel_admin_AddProduct" %>
...
<li>
                      <a href="#" class="active-menu-top"><i class="fa fa-asterisk "></i> Product<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                          <li>
                                <a href="AddProduct.aspx" class="active-menu"><i class="fa fa-plus-circle"></i>Add Product</a>
                            </li>
                             <li>
               ...
               <div class="panel panel-info">
                       ...
                       <div class="col-md-6  col-sm-6"> 
                                ...
                                <asp:Label ID="lblddlProType" runat="server" Text="Product Type" ></asp:Label>
                                             <asp:DropDownList AppendDataBoundItems="true" ID="cmbProType" CssClass="form-control" AutoPostBack="true"
                                                 runat="server" DataSourceID="SqlDataSource2" OnSelectedIndexChanged="cmbProType_SelectedIndexChanged"
                                      ...
                                      <asp:Label ID="Label4" runat="server" Text="All State Dealer Price"  ></asp:Label>
                                                <asp:TextBox ID="txtAllStatePrice" runat="server" class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ></asp:TextBox>
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <asp:TextBox ID="txtAllStateMRP" runat="server"  class="form-control" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ></asp:TextBox>
                                                 </div>  
                                                 
                                                     <div class="form-group">
                                                     <asp:Label ID="Label8" runat="server" Text="Index Number"   ></asp:Label>
                                                     <asp:TextBox ID="txtIndex" runat="server"  class="form-control" required onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" ></asp:TextBox>
                                                 </div>  
                                                     <div class="form-group">
                                        ...
                                        if (file) {
                                            ...
                                            preview.src = "";
                                                 ...
                                                 <div class="form-group">
                                                   ...
                                                   OnClientClick="return Confirm();"       onclick="btnAdd_Click"/>&nbsp;
