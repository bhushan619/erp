<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="Notification.aspx.cs" Inherits="Personnel_admin_Notification" %>
                 ...
                 <ul class="nav" id="main-menu">
                  ...
                  <li>
                   ...
                   <li>
                    ...
                    <li>
                        <a  href="Notification.aspx" class="active-menu"><i class="fa fa-bell "></i>Notifications</a>
                    </li>
                        ...
                        <div class="table-responsive">
                             <asp:ListView ID="lstNotification" runat="server" 
                                ...
                                onitemcommand="lstNotification_ItemCommand" 
                                 onitemdatabound="lstNotification_ItemDataBound" onpagepropertieschanging="lstNotification_PagePropertiesChanging" 
                           > 
                                <EmptyDataTemplate>
