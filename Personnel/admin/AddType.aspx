<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddType.aspx.cs" Inherits="Personnel_admin_AddType" %>
                      ...
                      <a href="#" class="active-menu-top"><i class="fa fa-asterisk "></i> Product<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in ">
                          <li>
                             ...
                             <li>
                                <a href="AddType.aspx" class="active-menu"><i class="fa fa-plus-circle"></i>Add Type</a>
                            </li>
                             <li>
                                ...
                                <div class="panel-body">
                                    <div class="col-md-4  col-sm-4">
                                        <div class="form-group">
                                            <asp:Label runat="server"> Add Product</asp:Label>
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <div class="table-responsive">
                                            ...
                                            <asp:ListView ID="listprodtype" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="ID" OnItemCommand="listprodtype_ItemCommand">
                                                ...
                                                <ItemTemplate>
                                                    <tr style="">
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btndelete" runat="server" CommandName="Deletes" CommandArgument='<%#Eval("ID")+","+Eval("varProductType")%>'
                                                                CssClass="btn btn-xs btn-danger" Text="Delete" />
                                                            <asp:Button ID="btnedit" runat="server" CommandName="Edits" Text="Edit" CommandArgument='<%#Eval("ID")+","+Eval("varProductType")%>' CssClass="btn btn-xs btn-success" />
                                                        </td>
                                                    </tr>
                                                </ItemTemplate>
                                                ...
                                                <LayoutTemplate>
                                                    <table runat="server">
                                                        ...
                                                        <tr runat="server">
                                                            <td runat="server" style="" colspan="3"></td>
                                                        </tr>
                                                    </table>
                                                </LayoutTemplate>
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:sanghaviunbreakablesConnectionString %>' ProviderName='<%$ ConnectionStrings:sanghaviunbreakablesConnectionString.ProviderName %>' SelectCommand="SELECT * FROM tblproducttype"></asp:SqlDataSource>
                                        </div>
                                    </div>
