...
public partial class Personnel_admin_Notification : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (!IsPostBack)
        {
            ...
            SqlDataSourceNotifications.SelectCommand = "SELECT varNotType,varNotText, varLink, varSession, varStatus, intId,varRemark,intNotFromId FROM tblsunotifications where (intNotToId = " + Convert.ToInt32(Session["adminid"].ToString()) + ") order by varStatus desc";
            notifications();
        }
    }
