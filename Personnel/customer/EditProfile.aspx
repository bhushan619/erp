<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="EditProfile.aspx.cs" Inherits="Personnel_customer_EditProfile" %>
                        ...
                        <asp:Image ID="imgProPic"   CssClass=" img-thumbnail"  runat="server"></asp:Image>
                             ...
                             <div class="inner-text"> 
                               <asp:Label ID="lblCustName" runat="server" Text="lblCustName"></asp:Label>
                                                    ...
                                                    <asp:Button ID="btnProfilePic" runat="server" Text="Change Picture" 
                      ...
                      Edit Profile
                       ...
                       <div class="panel-body">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#"  >Edit/Update Main Details</a>
                                </li>
                                <li class=""><a href="EditProfileOther.aspx"  >Edit/Update Other Details</a>
                                </li> 
                            </ul>
