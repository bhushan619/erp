<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="EditOrder.aspx.cs" Inherits="Personnel_customer_EditOrder" %>
            ...
            <div class="sidebar-collapse">
                 <ul class="nav" id="main-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a  href="#" class="active-menu-top"><i class="fa fa-plus-circle "></i> Order<span class="fa arrow"></span></a>
