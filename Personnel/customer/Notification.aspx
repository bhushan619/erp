<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="Notification.aspx.cs" Inherits="Personnel_customer_notifications" %>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                 <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="Notification.aspx"><i class="fa fa-bell "></i>Notification</a>
                    </li>
         ...
         <div class="panel panel-info">
              ...
              <div class="col-lg-12  text-right">
                 <asp:LinkButton ID="btnReadAll" runat="server" CssClass="btn btn-success btn-xs"  Text="Mark all as read" OnClick="btnReadAll_Click" />&nbsp;&nbsp;
                  <asp:LinkButton ID="lnkDeleteAll" CssClass="btn btn-danger btn-xs"  runat="server" Text="Delete all" OnClick="lnkDeleteAll_Click" />   </div>
                      <br /><br />
             </div>   
                        <div class="table-responsive">
                             <asp:ListView ID="lstNotification" runat="server" 
                                DataSourceID="SqlDataSourceNotifications" DataKeyNames="intId" onpagepropertieschanging="lstNotification_PagePropertiesChanging" 
                                onitemcommand="lstNotification_ItemCommand" onitemdatabound="lstNotification_ItemDataBound" 
                           > 
                                <EmptyDataTemplate>
                                    <table id="Table1" runat="server" style="">
                                        <tr>
                                            <td>
                                                No New Notifications.</td>
                                        </tr>
                                    </table>
                                </EmptyDataTemplate> 
                                <ItemTemplate>
                                    <tr >
                                        ...
                                        <asp:Panel ID="notificationpanel" runat="server">
                                         <asp:LinkButton ID="varNotTextLabel" runat="server"  CommandName="Views"   CssClass="alert alert-link"
                                    ...
                                    <table id="Table2" runat="server">
                                        <tr id="Tr1" runat="server">
                                            <td id="Td1" runat="server">
                                                <table ID="itemPlaceholderContainer" runat="server" border="0"  class="">
