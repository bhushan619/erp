 ...
 <a href="Default.aspx" class="btn btn-info" title="Profile"><i class="fa fa-user fa-2x"></i></a>
              ...
              <div class="sidebar-collapse">
                 <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <a class="active-menu" href="ViewProduct.aspx"><i class="fa fa-user "></i>View Products</a>
                    </li>
                     <li>
   ...
   <div style="display: inline-block; opacity: 1;" class="portfolio-item nature mix_all" data-cat="nature">
                      <asp:Image ID="ImgProduct" runat="server"  class="img-responsive " alt="" Height="250px" 
                                     ImageUrl="../media/NoProfile.png"  Width="250px"/>                       
                              <div class="overlay">   
                              <p>  <span>
                         ...
                         </p>   <a class="preview btn btn-info" id="prodimg" runat="server" title="Image Title Here" href="../assets/img/portfolio/d.jpg"><i class="fa fa-plus fa-2x"></i></a> <a href="ViewProduct.aspx" class="fa fa-arrow-left fa-2x btn btn-danger"></a> </div>
