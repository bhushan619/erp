                                                  ...
                                                  <ItemTemplate>
                                                   ...
                                                   <td style=" font-size: 12px;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dated : <asp:Label ID="dtDateLabel" runat="server" Text='<%# Eval("dtDate") %>' /></td>
                                                      ...
                                                      <td colspan="2" style=" font-size: 12px;">  Dispatched Through : <asp:Label ID="varDispatchThroughLabel" runat="server" 
                                                       ...
                                                       <tr >
                                                      <td colspan="2" style=" font-size: 12px;">Destination : <asp:Label ID="varDestinationLabel" runat="server" 
                                                              Text='<%# Eval("varDestination") %>' /></td>
                                                      </tr>
                                                       <tr >
                                                      <td colspan="2" style=" font-size: 12px;"> Mode Of Payment :   <asp:Label ID="VarModePaymentLabel" runat="server" 
                                                              Text='<%# Eval("VarModePayment") %>' /></td>
                                                      </tr>
                                                       <tr >
