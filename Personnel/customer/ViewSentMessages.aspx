<%@ Page MaintainScrollPositionOnPostback="true" Language="C#" AutoEventWireup="true" CodeFile="ViewSentMessages.aspx.cs" Inherits="Personnel_customer_ViewSentMessages" %>
                         ...
                         <ul class="nav nav-second-level collapse in">
                          <li>
                            ...
                            <li>
                              ...
                              <li>
                                <a class="active-menu"   href="ViewSentMessages.aspx"><i class="fa fa-inbox"></i>Sent Messages</a>
                            </li>
