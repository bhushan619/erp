<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewConsignment.aspx.cs" Inherits="Personnel_employee_dispatch_ViewConsignment" %>
             ...
             <div class="sidebar-collapse">
                 <ul class="nav" id="main-menu">
                    ...
                    <li>
                      ...
                      <li>
                        <a href="#" class="active-menu"><i class="fa fa-plus-circle "></i> Consignment<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in ">
                          <li>
                               <a href="ViewConsignment.aspx" class="active-menu-top"><i class="fa fa-cubes"></i>View Consignment</a>
                            </li>         
                            </ul>
                    </li>                         
                    <li>
