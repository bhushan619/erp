<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="Notification.aspx.cs" Inherits="Personnel_employee_Notification" %>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                 <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a  href="Notification.aspx" class="active-menu"><i class="fa fa-bell "></i>Notification</a>
                    </li>
