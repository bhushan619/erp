<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rejection.aspx.cs" Inherits="Personnel_employee_subadmin_Rejection" %>
                         ...
                         <ul class="nav nav-second-level  collapse in">
                          <li>
                            ...
                            <li>
                             ...
                             <li>
                                <a href="Rejection.aspx" class="active-menu-top"><i class="fa fa-pencil-square-o"></i>Rejection</a>
                            </li>
                            </ul>
                    </li>     
                     <li>
                                ...
                                Sack:<asp:Label ID="lblSack" runat="server" Text="Sack"></asp:Label> 
                                 ...
                                 <div class=" form-group">
                                    Nug: <asp:Label ID="lblNug" runat="server" Text="Nug"></asp:Label> 
                                                 ...
                                                 <div class="form-group">
                                                     <asp:Button ID="btnAddToOrder" runat="server" Text="Return"   OnClientClick="return Confirm();"
