<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="InwardStock.aspx.cs" Inherits="Personnel_employee_CreateStock" %>
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-plus-circle "></i> Stock<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                          <li>
                                <a href="RecieveStockJalgaon.aspx" class="active-menu-top"><i class="fa fa-share"></i>Recieve Stock</a>
                            </li>
                            <li>
