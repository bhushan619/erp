<%@ Page MaintainScrollPositionOnPostback="true" EnableViewStateMac="false" Language="C#" AutoEventWireup="true" CodeFile="CreateOrder.aspx.cs" Inherits="Personnel_employee_CreateOrder" %>
               ...
               <div class="panel panel-info">
                   ...
                   <div class="panel-body"> 
                     ...
                     <div class="form-group">
                         <asp:TextBox ID="txtBookingId"  placeholder="Booking ID" runat="server" CssClass="form-control" required></asp:TextBox>
                         </div>
                                    </div>
                       <div class="col-md-2 col-sm-2">
                     <div class="form-group">
...
<div class="col-md-8 col-sm-8">
 ...
 <div class="panel-body">
   ...
   <div class="form-group">
     <asp:TextBox ID="txtModeOfPayment" CssClass="form-control" placeholder="Payment Details" runat="server"></asp:TextBox>
 </div> 
 <div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
      <asp:TextBox ID="lblProductTotalPrice" runat="server" CssClass="form-control"  onkeyup="checkDec(this);"  Text="0" /> 
                     ...
                     <asp:HiddenField ID="hdnMsgAlert" runat="server" Value="Do you want to confirm order?" />
