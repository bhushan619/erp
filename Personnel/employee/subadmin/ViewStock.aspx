<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="ViewStock.aspx.cs" Inherits="Personnel_employee_ViewStock" %>
...
<body>
 ...
 <a href="Default.aspx" class="btn btn-info" title="Profile"><i class="fa fa-user fa-2x"></i></a>
                        ...
                        <a href="#" class="active-menu"><i class="fa fa-plus-circle "></i> Stock<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                          <li>
                            ...
                            <li>
                                <a href="ViewStock.aspx" class="active-menu-top"><i class="fa fa-pencil-square-o"></i>View stock</a>
                            </li>  <%-- <li>
  ...
  <div class="row">  
                  ...
                  <div id="output" class="col-lg-12 col-sm-12">    <asp:Button ID="btnJalgaonExport" runat="server"  CssClass=" btn btn-success" Text="Export In Excel" OnClick="btnJalgaonExport_Click"  />   &nbsp;&nbsp;     
