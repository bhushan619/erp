<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="ViewOrder.aspx.cs" Inherits="Personnel_employee_ViewOrder" %>
                        ...
                        <a href="#" class="active-menu"><i class="fa fa-plus-circle "></i> Order<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                          <li>
                            ...
                            <li>
                                <a href="ViewOrder.aspx" class="active-menu-top"><i class="fa fa-pencil-square-o"></i>View Pending Orders</a>
                            </li>
                            <li>
                            ...
                            <asp:ListView ID="listorder" runat="server" DataSourceID="SqlDataSource2"  onitemcommand="listorder_ItemCommand"
                                ...
                                <AlternatingItemTemplate>
                                    <tr style="">
                                        ...
                                        <td>
                                             <asp:LinkButton ID="lnkViewFull" CommandName="View" CommandArgument='<%#Eval("intOrderId")+","+ Eval("intCustId")%>' runat="server" ToolTip="View Order" CssClass="fa fa-eye fa-2x btn btn-xs btn-info"></asp:LinkButton>
                                    ...
                                    <tr style="">
                                        ...
                                        <td>
                                         ...
                                         <td>
                                             <asp:LinkButton ID="lnkViewFull" CommandName="View" CommandArgument='<%#Eval("intOrderId")+","+ Eval("intCustId")%>' runat="server" ToolTip="View Order" CssClass="fa fa-eye fa-2x btn btn-xs btn-info"></asp:LinkButton>
<%--                                              
                                             <asp:LinkButton ID="lnkApprove" CommandName="Approve"  CommandArgument='<%#Eval("intOrderId")+","+ Eval("intCustId")%>' runat="server" ToolTip="Approve Order" CssClass="fa fa-check btn btn-xs btn-success"></asp:LinkButton>
                                             <asp:LinkButton ID="LinkButton1" CommandName="Reject"  CommandArgument='<%#Eval("intOrderId")+","+ Eval("intCustId")%>' runat="server" ToolTip="Reject Order" CssClass="fa fa-times btn btn-xs btn-danger"></asp:LinkButton>--%>
                                         </td>
                                    </tr>
                                </ItemTemplate>
                                <EmptyDataTemplate>
