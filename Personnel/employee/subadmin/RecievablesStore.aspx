<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RecievablesStore.aspx.cs" Inherits="Personnel_employee_subadmin_RecievablesStore" %>
             ...
             <div class="sidebar-collapse">
                  <ul class="nav" id="main-menu">
                   ...
                   <li>
                      ...
                      <li>
                           <a  class="active-menu"  href="RecievablesStore.aspx"><i class="  fa fa-upload "></i>Upload Recievables File</a>
                    </li>
                                           <li>
                               ...
                               <asp:Label ID="Label2" runat="server" Text="Time:"></asp:Label> <asp:Label ID="lblTime" runat="server"  ></asp:Label>
                                ...
                                <div class="form-group">
                                   <div class="col-md-5 col-sm-5" >
                                    <asp:Label ID="lblUploadFile" runat="server" Text="Choose File"></asp:Label>
                                       <asp:FileUpload ID="fupFile" runat="server" CssClass="form-control btn-success" />
                                  <br />  <asp:Button ID="btnUpload" runat="server" CssClass="btn btn-danger" OnClientClick="return Confirm();"  Text="Upload File" OnClick="btnUpload_Click"  />
                                </div>
                                    </div>
                       <div class="col-md-5 col-sm-5" >
                           <asp:Label ID="Label3" runat="server" Text="Last File Upload:-" Font-Bold="True"></asp:Label>
