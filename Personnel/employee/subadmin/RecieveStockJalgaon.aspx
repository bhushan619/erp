<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="RecieveStockJalgaon.aspx.cs" Inherits="Personnel_employee_RecieveStockJalgaon" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head id="Head1" runat="server">
     ...
     <title>  Recieve Stock at Jalgaon </title>
                    ...
                    <li>
                        <a href="#" class="active-menu"><i class="fa fa-plus-circle "></i> Stock<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                          <li>
                                <a href="RecieveStockJalgaon.aspx" class="active-menu-top"><i class="fa fa-share"></i>Recieve Verkhedi Stock</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6">
               <div class="panel panel-info">
                        ...
                        Recieve Stock at Jalgaon
                    </div>
                      <div class="form-group" align="right">  
                        <asp:Label ID="lbf" runat="server" Text="Date:"></asp:Label>  
                        <asp:Label ID="ldate" runat="server" ></asp:Label>
                            <asp:Label ID="Label5" runat="server" Text="Time:"></asp:Label> <asp:Label ID="ltime"   runat="server" ></asp:Label>
                            </div>
                  ...
                  <div class="table-responsive">
                                <asp:GridView ID="grdStockManuf" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-responsive"
                                    ...
                                    onpageindexchanging="grdStockManuf_PageIndexChanging"  >
                                    <Columns>  
                                      <asp:BoundField DataField="dtDate" HeaderText="Date" 
                                        ...
                                        <asp:BoundField DataField="intNug" HeaderText="Nug" 
                                            ...
                                            <asp:TemplateField>
   <ItemTemplate>
   <asp:LinkButton ID="Button2" runat="server" Text="" CommandName="addstock"  CommandArgument='<%#Eval("intId") +","+ Eval("intSack")+","+Eval("intNug")+","+Eval("intProductId")+","+Eval("varProName")+","+Eval("varUnit")+","+Eval("varTransport")+","+Eval("dtDate") %>' CssClass="btn btn-xs btn-success fa fa-check" />
   </ItemTemplate>
   </asp:TemplateField>
                                    </Columns>
                                    <EmptyDataTemplate>
                                  <p class="btn btn-danger center-block">  No Record Found</p>
                                    </EmptyDataTemplate>
                                </asp:GridView>
                                ...
                                <asp:SqlDataSource ID="SqlDataSourceasdsd" runat="server" 
                                    ...
                                    SelectCommand="SELECT intId, intProductId,dtDate, varProName, intSack, intNug,varUnit,varTransport FROM tblsustockhistory WHERE (varRemark = @remark) ORDER BY CAST(STR_TO_DATE(dtDate,'%d-%m-%Y') AS DATE) DESC">
                               <SelectParameters>
                                          <asp:Parameter DefaultValue="SentToJalgaon" Name="Remark" Type="String" />
                                      </SelectParameters>
                                </asp:SqlDataSource>
                           </div>
             ...
             <!--/.ROW--> 
              ...
              <div class="col-md-6 col-sm-6 ">
               <div class="panel panel-info">
                        <div class="panel-heading">
                         Stock At Jalgaon Godown
                    </div>
                    <div class="panel-body">
                   <div class="table-responsive">
                              <asp:GridView ID="grdStockJalgaon" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-responsive"
                                    DataKeyNames="intId" DataSourceID="SqlDataSourceJalgaon" AllowPaging="True">
                                    <Columns>  
                                  ...
                                  <asp:SqlDataSource ID="SqlDataSourceJalgaon" runat="server" 
                                      ConnectionString="<%$ ConnectionStrings:sanghaviConnectionString %>" 
                                      ProviderName="<%$ ConnectionStrings:sanghaviConnectionString.ProviderName %>" 
                                      SelectCommand="SELECT sanghaviunbreakables.tblsuproducts.intId, CONCAT(tblsuproducts.nvarProductName,' ', tblsuproducts.intSize,' ', tblsuproducts.varUnit) as nvarProductName, sanghaviunbreakables.tblsustockjalgaon.intSack, sanghaviunbreakables.tblsustockjalgaon.intNug, 
