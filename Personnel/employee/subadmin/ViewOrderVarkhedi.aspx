<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewOrderVarkhedi.aspx.cs" Inherits="Personnel_employee_subadmin_ViewOrderVarkhedi" %>
                        ...
                        <a href="#" class="active-menu"><i class="fa fa-plus-circle "></i> Order<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                          <li>
                            ...
                            <li>
                                <a href="ViewOrderVarkhedi.aspx" class="active-menu-top"><i class="fa fa-pencil-square-o"></i>View Varkhedi Orders</a>
                            </li>
                          <%--  <li>
               ...
               <div class="panel panel-info">
                        ...
                        <div class="table-responsive center-block">
                            ...
                            <asp:SqlDataSource ID="SqlDataSourceOrderVarkhedi" runat="server" 
                                ...
                                SelectCommand="SELECT intId, dtDate, tmTime, varReason, varStatus FROM tblsuvarkhediorder order by CAST( STR_TO_DATE( tblsuvarkhediorder.dtDate,  '%d-%m-%Y' ) AS DATE )">
                            </asp:SqlDataSource>
                        </div>
                       </div>
