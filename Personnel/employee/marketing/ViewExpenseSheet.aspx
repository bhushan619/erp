<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewExpenseSheet.aspx.cs" Inherits="Personnel_employee_marketing_ViewExpenseSheet" %>
                            ...
                            <asp:GridView ID="grdView" runat="server" AutoGenerateColumns="false" OnRowCommand="grdView_RowCommand" CssClass="table table-bordered" >
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton CssClass=" fa fa-eye btn btn-danger" ID="aa" CommandArgument='<%# Eval("intId") %>' CommandName="edits" runat="server"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
