                                 ...
                                 <ItemTemplate>
                                    <tr style="">
                                        ...
                                        <td>
                                         ...
                                         <td>
                                             <asp:LinkButton ID="lnkViewFull" CommandName="View" CommandArgument='<%#Eval("intOrderId")+","+ Eval("intCustId")%>' runat="server" ToolTip="View Order" CssClass="fa fa-eye btn btn-xs btn-info fa-2x"></asp:LinkButton>
