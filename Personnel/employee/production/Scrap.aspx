<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Scrap.aspx.cs" Inherits="Personnel_employee_production_Scrap" %>
                         ...
                         <ul class="nav nav-second-level collapse in">
                           ...
                           <li>
                            ...
                            <li>
                             ...
                             <li>
                               <a  class="active-menu-top" href="Scrap.aspx"><i class="fa fa-cubes"></i>Scrap</a>
                            </li>
                              <li>
                              ...
                              <div class=" form-group">
                                Sack:<asp:Label ID="lblSack" runat="server" Text="Sack"></asp:Label> 
                                 ...
                                 <div class=" form-group">
                                    ...
                                    <div class="form-group">
                                        <asp:Button ID="btnAddToOrder" runat="server" Text="Scrap"   OnClientClick="return Confirm();"
