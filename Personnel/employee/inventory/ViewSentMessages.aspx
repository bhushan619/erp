<%@ Page MaintainScrollPositionOnPostback="true" Language="C#" AutoEventWireup="true" CodeFile="ViewSentMessages.aspx.cs" Inherits="Personnel_admin_ViewSentMessages" %>
                        ...
                        <a href="#"><i class="fa fa-plus-circle "></i> Order<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level ">
                          <li>
                            ...
                            <li>
                                <a href="ViewApprovedOrders.aspx"><i class="fa fa-pencil-square-o"></i>Approved Orders</a>
                            </li>
                            <li>
                        ...
                        <a href="#" class="active-menu"><i class="fa fa-envelope "></i>Messages<span class="fa arrow"></span></a>
                         ...
                         <li>
                          ...
                          <li>
                             ...
                             <li>
                                <a class="active-menu-top" href="ViewSentMessages.aspx"><i class="fa fa-inbox"></i>Sent Messages</a>
                            </li>
                        </ul>
                    </li> 
