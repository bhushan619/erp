...
public partial class Personnel_employee_inventory_InwardMaterial : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (confirmValue == "Yes")
            {
                ...
                else
                {
                    ...
                    int insert_ok = dbc.update_sumaterialsAdd(txtDate.Text, txtTime.Text, ddlProduct.Text, txtQuantity.Text, txtReason.Text);
                    ...
                    if (insert_ok == 1)
                    {
                      ...
                      this.GetType(),
                      "MessageBox",
                      "alert('Updated Succesfully');window.location='InwardMaterial.aspx';", true);
                        clear();
                    }
                    else
                    {
