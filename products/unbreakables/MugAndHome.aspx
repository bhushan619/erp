<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="MugAndHome.aspx.cs" Inherits="products_unbreakables_MugAndHome" %>
...
<head id="Head1" runat="server">
    ...
    <title>Mug & Home -Clean Article | Sanghavi Polymers | Unbreakables, PVC, Solar, Cleaning Aids</title>
						 ...
						 <asp:SqlDataSource ID="SqlDataSourceUnb" runat="server" 
                                    ...
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="Unbreakables" Name="type" 
                                            Type="String" />
                                              <asp:Parameter DefaultValue="MUG-HOME–CLEAN" Name="subtype" 
                                            Type="String" />
