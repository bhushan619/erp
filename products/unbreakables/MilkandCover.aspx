<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="MilkandCover.aspx.cs" Inherits="products_unbreakables_MilkandCover" %>
...
<head runat="server">
    ...
    <title>Milk Cans & Manhole Covers | Sanghavi Polymers | Unbreakables, PVC, Solar, Cleaning Aids</title>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#" class="active" >Products<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="Unbreakables.aspx">Unbreakables</a></li>
										<li><a href="../CleaningAids/CleaningAids.aspx">Cleaning Aids</a></li> 
			...
			<div class="row">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								...
								<div id="sportswear" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="Ghamela.aspx">Ghamela </a></li>
											<li><a href="Bucket.aspx">Bucket </a></li>
											<li><a href="Tagari.aspx">Tagari </a></li>
											<li><a href="Ghagar.aspx">Ghagar</a></li>
											<li><a href="TubCrate.aspx">Tub-Crate </a></li>
                                            <li><a href="MugAndHome.aspx">Mug & Home </a></li>
                                            <li><a href="MilkandCover.aspx">Milk Cans & Cover </a></li> 
										</ul>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								...
								<div id="mens" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="../CleaningAids/DryDust.aspx">Dry-Dust</a></li>
											<li><a href="../CleaningAids/WetMop.aspx">Wet Mop</a></li>
											<li><a href="../CleaningAids/Wiper.aspx">Wiper</a></li>
											<li><a href="../CleaningAids/ChokerBroomDustar.aspx">Broom, Duster & Choker</a></li> 
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Unbreakables</h2>
						 ...
						 <asp:SqlDataSource ID="SqlDataSourceUnb" runat="server" 
                                    ...
                                    SelectCommand="SELECT distinct nvarProductName, imgImage FROM tblsuproducts WHERE (nvarProductType =@type) AND nvarProductSubType =@subtype OR nvarProductSubType =@subtype1 ORDER BY tblsuproducts.intId ASC">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="Unbreakables" Name="type" 
                                            Type="String" />
                                              <asp:Parameter DefaultValue="MHC" Name="subtype" 
                                            Type="String" />
                                                
                                               <asp:Parameter DefaultValue="CAN" Name="subtype1" 
                                            Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource> 
