<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="Tagari.aspx.cs" Inherits="products_unbreakables_Tagari" %>
...
<head id="Head1" runat="server">
    ...
    <title>Tagari | Sanghavi Polymers | Unbreakables, PVC, Solar, Cleaning Aids</title>
						 ...
						 <asp:SqlDataSource ID="SqlDataSourceUnb" runat="server" 
                                    ...
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="Unbreakables" Name="type" 
                                            Type="String" />
                                              <asp:Parameter DefaultValue="TAGARI" Name="subtype" 
                                            Type="String" />
