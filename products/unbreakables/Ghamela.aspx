<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="Ghamela.aspx.cs" Inherits="products_unbreakables_Ghamela" %>
...
<head id="Head1" runat="server">
    ...
    <title>Ghamela | Sanghavi Polymers | Unbreakables, PVC, Solar, Cleaning Aids</title>
						 ...
						 <asp:SqlDataSource ID="SqlDataSourceUnb" runat="server" 
                                    ...
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="Unbreakables" Name="type" 
                                            Type="String" />
                                              <asp:Parameter DefaultValue="GHAMELA" Name="subtype" 
                                            Type="String" />
