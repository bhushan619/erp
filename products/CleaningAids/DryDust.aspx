<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="DryDust.aspx.cs" Inherits="products_CleaningAids_DryDust" %>
...
<head id="Head1" runat="server">
    ...
    <title>Dry Dust | Sanghavi Polymers | Unbreakables, PVC, Solar, Cleaning Aids</title>
						 ...
						 <asp:SqlDataSource ID="SqlDataSourceUnb" runat="server" 
                                    ...
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="Cleaning Aids" Name="type" 
                                            Type="String" />
                                              <asp:Parameter DefaultValue="DRY/DUST" Name="subtype" 
                                            Type="String" />
