<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="ChokerBroomDustar.aspx.cs" Inherits="products_CleaningAids_Choker" %>
...
<head id="Head1" runat="server">
    ...
    <title>Choker,Broom & Duster | Sanghavi Polymers | Unbreakables, PVC, Solar, Cleaning Aids</title>
					...
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Cleaning Aids Items</h2>
						 ...
						 <asp:SqlDataSource ID="SqlDataSourceUnb" runat="server" 
                                    ...
                                    SelectCommand="SELECT distinct nvarProductName, imgImage FROM tblsuproducts WHERE (nvarProductType =@type) AND nvarProductSubType =@subtype OR nvarProductSubType =@subtype1 OR nvarProductSubType =@subtype2 ORDER BY tblsuproducts.intId ASC">
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="Cleaning Aids" Name="type" 
                                            Type="String" />
                                              <asp:Parameter DefaultValue="CHOKER" Name="subtype" 
                                            Type="String" />
                                               <asp:Parameter DefaultValue="COTTON-DUSTER" Name="subtype1" 
                                            Type="String" />
                                               <asp:Parameter DefaultValue="PLASTIC-BROOM" Name="subtype2" 
                                            Type="String" />
                                    </SelectParameters>
                                </asp:SqlDataSource> 
        ...
        <asp:Panel ID="pnlPopup" runat="server" CssClass="modalPopup" Style="display: none">
            ...
            <div role="form">
              ...
              <asp:Button ID="btnSaves" runat="server" Text="Ask Price" OnClick = "Save" CssClass="btn btn-info" />
				...
				<%--<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Unbreakable Items</h2>

						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="../../images/Product Images/CleaningAid/cleaning-aid-c1.jpg" alt="" />
											<h2>Chokers</h2>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="../../images/Product Images/CleaningAid/cleaning-aid-c2jpg.jpg" alt="" />
										<h2>Cotton Duster</h2>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="../../images/Product Images/CleaningAid/cleaning-aid-c3.jpg" alt="" />
										<h2>Plastic Broom</h2>
								...
								<div class="item active">	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="../../images/product-details/sanghavi-plastic-5.jpg" alt="" />
													<h2>Mug</h2>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="../../images/product-details/sanghavi-plastic-7.jpg" alt="" />
													<h2>Bath Stool</h2>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="../../images/product-details/sanghavi-plastic-11.jpg" alt="" />
													<h2>Fruit Crate</h2>
								...
								<div class="item">	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="../../images/product-details/sanghavi-plastic-15.jpg" alt="" />
													<h2>Mats</h2>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="../../images/product-details/sanghavi-plastic-17.jpg" alt="" />
													<h2>Milk Can</h2>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="../../images/product-details/cleaning-aid-21.jpg" alt="" />
													<h2>Chokers</h2>
