<%@ Page MaintainScrollPositionOnPostback="true"  Language="C#" AutoEventWireup="true" CodeFile="WetMop.aspx.cs" Inherits="products_CleaningAids_WetMop" %>
...
<head id="Head1" runat="server">
    ...
    <title>Wet Mop| Sanghavi Polymers | Unbreakables, PVC, Solar, Cleaning Aids</title>
						 ...
						 <asp:SqlDataSource ID="SqlDataSourceUnb" runat="server" 
                                    ...
                                    <SelectParameters>
                                        <asp:Parameter DefaultValue="Cleaning Aids" Name="type" 
                                            Type="String" />
                                              <asp:Parameter DefaultValue="WET-MOP" Name="subtype" 
                                            Type="String" />
